...
It is so the next developer can read your code easily

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Block takes up the full width available, and has a new line before and after
Inline takes up only as much as needed, and does not force new lines
...
it allows multiple users to work on the sdame project all at once
